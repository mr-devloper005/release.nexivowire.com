...
export function EmptyState({
  ...
  return (
    <section className={cn('rounded-[2rem] border border-[rgba(12,44,85,0.12)] bg-white p-8 text-center shadow-[0_18px_48px_rgba(12,44,85,0.06)]', className)}>
      ...
      <Link href={actionHref} className="nexivo-button mt-6 px-5 py-3">
        {actionLabel}
